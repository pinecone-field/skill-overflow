...
export const submitSkillTool = {
  name: 'submit_skill',
  description: 'Embed and store a new skill in Skill Overflow. Call this after completing any repeatable multi-step process. The description is embedded using llama-text-embed-v2 which has a 2048 token max input size — keep descriptions concise and under 2048 tokens.',
  inputSchema: {
    type: 'object',
    properties: {
